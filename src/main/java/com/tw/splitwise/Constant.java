...
public class Constant {
    ...
    static final Double defaultExpenseRatio = 1.0;
    public static final double splitwiseRate = 0.02;
    static final String splitwiseAdminName = "Splitwise";
    public final static String sourceCurrencyMessage = "Enter the source currency (INR, USD, JPY, EUR)";
    public final static String destinationCurrencyMessage = "Enter the destination currency (INR, USD, JPY, EUR)";
